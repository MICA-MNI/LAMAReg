...
# Load images
fixed = ants.image_read("example_data/sub-HC001_ses-01_T1w.nii.gz")
moving = ants.image_read("example_data/sub-HC001_ses-02_space-dwi_desc-b0.nii.gz")
# Set ANTs/ITK thread count

env = os.environ.copy()
env["ITK_GLOBAL_DEFAULT_NUMBER_OF_THREADS"] = str(36)
env["OMP_NUM_THREADS"] = str(36)  # OpenMP threads for ANTs
...
try:
    results_half = calculate_all_metrics(
        "example_data/sub-HC001_ses-01_T1w.nii.gz",
